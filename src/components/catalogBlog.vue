<template>
  <section class="catalog">
    ...
    <div class="catalog__finder catalog__finder_blog">
      <form @submit.prevent="search" class="catalog__searchbar searchbar searchbar_blog">
        <input type="text" name="searchbar__input" class="searchbar__input" placeholder="Поиск" v-model="input">
        <button class="searchbar__btn"><img src="../assets/search.png" alt="Find" class="searchbar__btn-img"></button>
      </form>
    ...
    <div class="catalog__content">
      <div class="card" v-if="props.blogs.length" v-for="item in props.blogs" :key="item.id" @click="selectBlog(item.id)">
...
import {IDataBlogs} from "../plugins/blogs.ts";
